  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "userCode",
        .dataTypeSpecific.className = NULL,
        .number = LoginReq_FieldNumber_UserCode,
        .hasIndex = 5,
        .offset = (uint32_t)offsetof(LoginReq__storage_, userCode),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
    };
    ...
    static const char *extraTextFormatInfo =
        "\006\001\006\000\002\014\000\003\t\000\004\007\000\005\n\000\006\010\000";
...
GPBEnumDescriptor *LoginReq_LoginType_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "Mobile\000Pc\000MobileCode\000";
    static const int32_t values[] = {
        LoginReq_LoginType_Mobile,
        LoginReq_LoginType_Pc,
        LoginReq_LoginType_MobileCode,
    };
...
BOOL LoginReq_LoginType_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case LoginReq_LoginType_MobileCode:
      return YES;
    default:
      return NO;
  }
...
@dynamic groupItemArray, groupItemArray_Count;
@dynamic hasShareFileCount, shareFileCount;
@dynamic hasShareFileLimit, shareFileLimit;
@dynamic hasDownloadingLimit, downloadingLimit;

typedef struct LoginRsp__storage_ {
  uint32_t _has_storage_[1];
  LoginRsp_ResultCode resultCode;
  LoginRsp_MainMobileCode mainMobileCode;
  int32_t shareFileCount;
  int32_t shareFileLimit;
  int32_t downloadingLimit;
  NSMutableArray *userItemArray;
  NSMutableArray *chatItemArray;
  NSString *userMac;
  NSMutableArray *groupItemArray;
} LoginRsp__storage_;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = LoginRsp_FieldNumber_GroupItemArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(LoginRsp__storage_, groupItemArray),
        .flags = (GPBFieldFlags)(GPBFieldRepeated | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "shareFileCount",
        .dataTypeSpecific.className = NULL,
        .number = LoginRsp_FieldNumber_ShareFileCount,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(LoginRsp__storage_, shareFileCount),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
      ...
      },
      {
        .name = "shareFileLimit",
        .dataTypeSpecific.className = NULL,
        .number = LoginRsp_FieldNumber_ShareFileLimit,
        .hasIndex = 4,
        .offset = (uint32_t)offsetof(LoginRsp__storage_, shareFileLimit),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeInt32,
      },
      {
        .name = "downloadingLimit",
        .dataTypeSpecific.className = NULL,
        .number = LoginRsp_FieldNumber_DownloadingLimit,
        .hasIndex = 5,
        .offset = (uint32_t)offsetof(LoginRsp__storage_, downloadingLimit),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeInt32,
      },
    };
...
#if !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    static const char *extraTextFormatInfo =
        "\t\001\n\000\002\000userItem\000\003\000chatItem\000\004\007\000\005\016\000\006\000groupI"
        "tem\000\007\016\000\010\016\000\t\020\000";
    [localDescriptor setupExtraTextInfo:extraTextFormatInfo];
#endif  // !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
...
GPBEnumDescriptor *LoginRsp_ResultCode_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "honeoutline\000Usercodewrong\000";
    static const int32_t values[] = {
        ...
        LoginRsp_ResultCode_Usercodewrong,
    };
    GPBEnumDescriptor *worker =
...
BOOL LoginRsp_ResultCode_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case LoginRsp_ResultCode_Usercodewrong:
      return YES;
    default:
      return NO;
  }
