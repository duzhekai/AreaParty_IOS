 ...
 **/
@interface FileDataRoot : GPBRootObject
@end

#pragma mark - FileItem

typedef GPB_ENUM(FileItem_FieldNumber) {
  FileItem_FieldNumber_FileId = 1,
  FileItem_FieldNumber_FileName = 2,
  FileItem_FieldNumber_FileInfo = 3,
  FileItem_FieldNumber_FileSize = 4,
