...
{
    LoadingViewForOC *loadingView = [[LoadingViewForOC alloc] initWithFrame:CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width*0.75,[UIScreen mainScreen].bounds.size.width*0.5)];
